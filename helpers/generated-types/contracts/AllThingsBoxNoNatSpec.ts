...
export declare namespace AllThingsBoxNoNatSpec {
...
export interface AllThingsBoxNoNatSpecInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [
      ...
      string,
      string[],
      AllThingsBoxNoNatSpec.CoolStructStruct
    ]
  ): string;
  encodeFunctionData(
...
export interface AllThingsBoxNoNatSpec extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AllThingsBoxNoNatSpecInterface;
  ...
  functions: {
    ...
    ): Promise<[AllThingsBoxNoNatSpec.CoolStructStructOutput]>;
