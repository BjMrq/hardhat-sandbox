...
export declare namespace DaoNat {
  export type ClearProposalStruct = {
  ...
  export type ClearProposalStructOutput = [
    string[],
    BigNumber[],
    string[],
    string
...
export interface DaoNatInterface extends utils.Interface {
  functions: {
...
export interface DaoNat extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DaoNatInterface;
  ...
  functions: {
    ...
    ): Promise<[DaoNat.ClearProposalStructOutput]>;
